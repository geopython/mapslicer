...
AppName=MapTiler
AppVerName=MapTiler version 1.0 alpha2
...
OutputBaseFilename=maptiler-1.0-alpha2-setup
Compression=lzma
...
Source: "dist\gdaldata\*"; DestDir: "{app}\gdaldata\"
...
[Icons]
Name: "{group}\MapTiler 1.0 alpha2"; Filename: "{app}\maptiler.exe"; WorkingDir: "{app}"
