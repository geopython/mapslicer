...
fpm -s dir -t deb -a all -n mapslicer -v 1.0.beta3 --description='Map Tile Generator for Mashups' -d python-gdal -d python-wxgtk2.8 -d python /usr/share/doc/mapslicer/ /usr/lib/mapslicer/ /usr/share/mapslicer/icon.png /usr/share/applications/mapslicer.desktop
